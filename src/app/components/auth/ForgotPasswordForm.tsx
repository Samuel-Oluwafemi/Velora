      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className="w-full border border-border bg-background px-4 py-3.5 text-foreground outline-none transition-colors 
        ...
        <button
          ...
          className="flex w-full cursor-pointer items-center justify-center gap-2 bg-foreground py-3.5 text-xs uppercase
           tracking-[0.14em] text-primary-foreground transition-colors hover:bg-accent hover:text-foreground 
