    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="relative w- full overflow-hidden md:h-[133svh] h-[110svh] min-h-[600px] max-h-[1000px]">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(26,26,26,0.08) 0%, rgba(26,26,26,0.35) 100%)",
          }}
        />
          ...
          {[
            {
              ...
              sub: "Made in Italy, Portugal & Japan",
            },
            {
              icon: "✦",
              label: "Premium Materials",
              sub: "Wool, Silk, Cashmere & Linen",
            },
            {
              icon: "✦",
              label: "Free Returns",
            ...
            <div key={item.label} className="flex flex-col items-center gap-2">
              <span className="text-accent" style={{ fontSize: "0.8rem" }}>
                {item.icon}
              </span>
              <p
                className="text-foreground"
